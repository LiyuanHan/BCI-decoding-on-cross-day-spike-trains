...
for turn in range(turns):
	...
	# today = '2024-01-25-v1-p2-delete_pureGRU_single_turn_' + str(turn)  # train:80%, test: 20%; standard embedding: Day_from (no shuffle)
	today = '2024-01-25-v2-p2-delete_pureGRU_single_turn_' + str(turn)  # train:80%, test: 20%; standard embedding: Day_from (shuffled)

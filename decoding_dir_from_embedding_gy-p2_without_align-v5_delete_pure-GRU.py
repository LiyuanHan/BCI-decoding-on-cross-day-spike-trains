...
for turn in range(turns):
	...
	print('turn: ', turn)
	# today = '2023-11-28-v2-p2-delete-pureGRU-turn_' + str(turn)  # train:pre 4 weeks, test: next week; standard embedding: Day_to + 1
	today = '2023-11-28-v3-p2-delete-pureGRU-turn_' + str(turn)  # train:pre 4 weeks, test: next all; standard embedding: Day_to
	...
	output_acc_without_align.append([(correct / total) * 100, (correct2 / total) * 100, (correct3 / total) * 100, seeds])
